    ...
    const data = [
        {
          ...
          "__v": 0,
          "image": "https://res.cloudinary.com/dpvqcjwud/image/upload/v1740380732/image2_g9xin7.jpg",
        },
        {
      ...
      {data.map((product) => (
        ...
        >
          ...
          <div className="px-6 py-4">
            <h2 className="font-bold text-xl text-white "> {product.brand} {product.model}</h2>
            <p className="text-sm text-neutral-100 ">{product.category} | {product.year}</p>
            <p className="mt-2 text-neutral-100">{product.description}</p>
          </div>
          <div className="px-6 pb-4 flex justify-between items-center">
            <span className="text-xl font-semibold text-neutral-200">${product.price}</span>
            <span
